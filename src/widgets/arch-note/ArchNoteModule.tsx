...
function ArchNoteModule() {
  const [workspaces, setWorkspaces] = useState<ArchWorkspace[]>([]);
  const [categories, setCategories] = useState<ArchCategory[]>([]);
  const [sections, setSections] = useState<ArchSection[]>([]);
  const [notes, setNotes] = useState<ArchNote[]>([]);

  const [selectedWorkspace, setSelectedWorkspace] = useState<string | null>(null);
  const [selectedCategory, setSelectedCategory] = useState<string | null>(null);
  const [selectedSection, setSelectedSection] = useState<string | null>(null);
  const [selectedNote, setSelectedNote] = useState<ArchNote | null>(null);
